...
public class StacksAndQueues extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.stacks_and_queues);


        //Link Show
        LinkText = findViewById(R.id.Linkshowstacksandqueues);
        String setlink = "https://drive.google.com/file/d/1HxKI5BEvRVSrSKs67VDQ1t7VUD2sv-rC/view?usp=sharing";
        LinkText.setText(setlink);

        //Link Show End

        //for video player
        VideoPlayer = findViewById(R.id.code_stacks_and_queues_video);
        ...
        //for 1st card view
        layout1=(LinearLayout) findViewById(R.id.layout_stacks_and_queues_q1);
        layout1.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        code1=(TextView) findViewById(R.id.code_stacks_and_queues_q1);

        //for 2nd card view
        layout2=(LinearLayout) findViewById(R.id.layout_stacks_and_queues_q2);
        layout2.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        code2=(TextView) findViewById(R.id.code_stacks_and_queues_q2);
    }

    public void expand_stacks_and_queues_q1(View v){
    ...
    public void expand_stacks_and_queues_q2(View v){
