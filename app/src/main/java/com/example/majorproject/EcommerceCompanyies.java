...
public class EcommerceCompanyies extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View v) {
        ...
        else if(v.equals(amazon_image)){
            String about_company_heading=getResources().getString(R.string.amazon_about_heading);
            String about_company_content=getResources().getString(R.string.amazon_about_content);
            String hiring_details_heading=getResources().getString(R.string.amazon_hiring_details_heading);
            String hiring_details_content=getResources().getString(R.string.amazon_hiring_details_content);
            Intent it=new Intent(this,CompanySpecificGeneralLayout.class);
            it.putExtra("about_company_heading",about_company_heading);
            it.putExtra("about_company_content",about_company_content);
            it.putExtra("hiring_details_heading",hiring_details_heading);
