...
public class Greedy extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        //Link Show
        LinkText = findViewById(R.id.Linkshowgreedy);
        String setlink = "https://drive.google.com/file/d/1qZhNk4GNFUf8CC5yOh-kgW2EM9qPKLOX/view?usp=drive_link";
        LinkText.setText(setlink);

        //Link Show End

        //for video player
        VideoPlayer = findViewById(R.id.greedy_video);
        ...
        //for 1st card view
        layout1=(LinearLayout) findViewById(R.id.layout_greedy_q1);
        layout1.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        code1=(TextView) findViewById(R.id.code_greedy_q1);

        //for 2nd card view
        layout2=(LinearLayout) findViewById(R.id.layout_greedy_q2);
        layout2.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        code2=(TextView) findViewById(R.id.code_greedy_q2);
    }

    public void expand_greedy_q1(View v){
    ...
    public void expand_greedy_q2(View v){
