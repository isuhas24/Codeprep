...
public class LandingPage extends AppCompatActivity implements View.OnClickListener{
    ...
    ImageView mobility_image,ecommerce_image,crm_image,cloud_image,collaboration_image,communication_image,advertisement_image,payment_image,investment_image,gaming_image,entertainment_image;
