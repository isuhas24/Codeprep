...
public class Backtracking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.backtracking);


        //Link Show
        LinkText = findViewById(R.id.Linkshowbacktracking);
        String setlink = "https://drive.google.com/file/d/1vQvqj7glo7TamMIGgQcq7eORzBtIkgct/view?usp=drive_link";
        LinkText.setText(setlink);

        //Link Show End

        //for video player
        VideoPlayer = findViewById(R.id.backtracking_video);
        ...
        //for 1st card view
        layout1=(LinearLayout) findViewById(R.id.layout_backtracking_q1);
        layout1.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        code1=(TextView) findViewById(R.id.code_backtracking_q1);

        //for 2nd card view
        layout2=(LinearLayout) findViewById(R.id.layout_backtracking_q2);
        layout2.getLayoutTransition().enableTransitionType(LayoutTransition.CHANGING);
        code2=(TextView) findViewById(R.id.code_backtracking_q2);
    }

    public void expand_backtracking_q1(View v){
    ...
    public void expand_backtracking_q2(View v){
